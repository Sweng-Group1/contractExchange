...
public abstract class Shape extends PresElement {
	...
	protected Shape(Point pos, int width, int height, float duration, Slide slide, Color fillColour, Border border, Shadow shadow) {
	 ...
	 * Maps a value within certain bounds onto another pair of bounds.
